...
urlpatterns = [
    ...
    path("api/auth/checkSession/", views.check_session, name="check_session"),
    path("api/auth/google/", views.googleAuth, name="googleAuth_view"),
    path("api/auth/androidGoogleAuth/", views.android_auth, name="googleAndroidAuth_view"),
    path("api/auth/authorizeGoogleAccesss/", views.authorize_google_access, name="update_google_access_token"),
    #path('admin/', admin.site.urls),
